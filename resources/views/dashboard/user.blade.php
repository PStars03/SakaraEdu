...
@section('content')
    ...
    <div class="grid gap-6 md:grid-cols-3">
        ...
        <div class="space-y-4">
            ...
            <a href="#" class="rounded-2xl bg-white p-5 shadow-sm border border-slate-100 flex items-center gap-4 hover:border-fresh-green hover:shadow-md transition-all group opacity-75 cursor-not-allowed">
                ...
                <div>
                    <p class="text-sm font-bold text-deep-navy">Bootcamp & Beasiswa</p>
