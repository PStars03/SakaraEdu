        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 -translate-x-full transform bg-deep-navy text-white transition-transform duration-300 ease-in-out md:relative md:translate-x-0"
            ...
            <nav class="mt-6 flex flex-col space-y-1 px-4">
                @if(auth()->user()->isUser())
                    ...
                    <a href="{{ route('ai-advisor.index') }}" class="{{ request()->routeIs('ai-advisor.*') ? 'bg-gradient-to-r from-primary-blue to-sky-blue text-white' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} flex items-center rounded-xl px-4 py-3 text-sm font-medium transition-colors">
                    ...
                    <a href="{{ route('user.tickets.index') }}" class="{{ request()->routeIs('user.tickets.*') ? 'bg-gradient-to-r from-primary-blue to-sky-blue text-white' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} flex items-center rounded-xl px-4 py-3 text-sm font-medium transition-colors">
                        <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" /></svg>
                        Tiket Saya
                    </a>
                @endif
